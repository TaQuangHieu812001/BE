...
namespace FunitureApp.Areas.admin.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UserName,Password,Email,CreateOn,CreateBy,ModifiedOn,ModifiedBy")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserName,Password,Email,CreateOn,CreateBy,ModifiedOn,ModifiedBy")] User user)
        {
            if (id != user.Id)
            {
                return NotFound();
